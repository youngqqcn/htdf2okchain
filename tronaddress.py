...
def PubKeyToAddr(pubKey, isTestnet = False):
    ...
    addr1 = sha3.keccak_256(unhexlify(pubKey)[1:]).digest()
...
def main2():
    ...
    # addrs =  GenMultiAddr(1, False)
    # print(addrs)
    pubkey = '03c0db929607303c8106ab8bc2add8648eb6b78d37d6d0e0caa31455a64e3ff6b0'
    print(PubKeyToAddr(pubkey, False))
